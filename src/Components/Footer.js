    ...
    <div className="footer-section">
      <div className="footer-container">
        <div className="ft-info">
          <div className="ft-info-p1">
            <p className="ft-title">
              Curetica <span className="ft-sign">+</span>
            </p>
        ...
        <div className="ft-list" id="contact">
          ...
          <ul className="ft-list-items">
            <li>
              <a href="mailto:support@curetica.com">support@curetica.com</a>
            </li>
            <li>
              <a href="mailto:appointment@curetica.com">
                appointment@curetica.com
              </a>
            </li>
            <li>
      ...
      <div className="ft-copyright">
        ...
        <ul className="ft-social-links">
          <li>
            <a
              href="https://www.linkedin.com/in/rohit-bhardwaj-590725297/"
              title="LinkedIn"
              target="_blank"
